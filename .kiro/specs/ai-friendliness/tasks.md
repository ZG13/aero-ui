...
- [ ] 1. 编写 AI_CONTEXT.md 全局上下文
- [ ] 1.1 建立 AI_CONTEXT.md 骨架与项目定位章节
...
- [ ] 2. 编写 ai-doc 组件级 prompt 模板
- [ ] 2.1 (P) 编写 AeroButton prompt 模板
