...
- [ ] 1. 基础 token 迁移与按类型拆分
- [ ] 1.1 (P) 迁移色板到 `packages/theme/base/color.scss`
...
- [ ] 1.2 (P) 拆分 `base/number.scss` 为 number / font / typography / opacity
...
- [ ] 1.3 (P) 新建 radius / stroke / insets 基础 token
...
- [ ] 2.2 (P) 创建 `packages/theme/dark.scss`（dark 绑定）
...
- [ ] 3. 主题入口与迁移收尾
- [ ] 3.1 创建主题入口 `packages/theme/index.scss`
